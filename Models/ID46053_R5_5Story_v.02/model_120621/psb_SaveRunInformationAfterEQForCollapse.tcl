...
# Modified by: Prakash Singh Badal of IIT Bombay, updated on 28-Mar-2016
...
#			close $filename23 
			...
			set filename29 [open maxStoryResidualDriftRatioForFullStrOUT.out w]
            puts $filename29 $maxStoryResidualDriftRatioForFullStr
            close $filename29

            set filename30 [open minStoryResidualDriftRatioForFullStrOUT.out w]
            puts $filename30 $minStoryResidualDriftRatioForFullStr
            close $filename30
			
			set filename31 [open absStoryResidualDriftRatioForFullStrOUT.out w]
			puts $filename31 $absStoryResidualDriftRatioForFullStr
			close $filename31
