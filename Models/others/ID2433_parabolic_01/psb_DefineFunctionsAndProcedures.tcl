...
if {$eqTimeHistoryPreFormatted == 1} {
	...
	set dtFile [open "C:/OpenSeesProcessingFiles/EQs/DtFile_($eqNumber).txt" r]
	set dt [read $dtFile]
	close $dtFile

	set numPtFile [open "C:/OpenSeesProcessingFiles/EQs/NumPointsFile_($eqNumber).txt" r]
