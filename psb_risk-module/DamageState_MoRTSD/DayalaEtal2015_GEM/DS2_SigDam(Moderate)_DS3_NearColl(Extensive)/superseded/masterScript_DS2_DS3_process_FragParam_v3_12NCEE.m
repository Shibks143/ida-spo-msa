...
bldgIDLIST1 = {'2227v05_sca2',	'2229v03_sca2',	'2231v04_sca2',	'2233v03_sca2',	'2235v04_sca2',	'2237v03a_sca2'};
...
%% (1/3) carrying out parametrized study over the limit of chi (= thetaM/thetaU) of most critical column
...
%             fileName1 = sprintf('DATA_criticalCol_xi_%ip%i_SaAndStats.mat', floor(LimitStateVal), int8(LimitStateVal*100));
    ...
    fileNameToSave = 'DS2_DS3_fragDataCS22_SaTa_12NCEE';
...
%             fprintf('Processing building- %i/%i, chi- %i/%i...\n', i, size(bldgIDLIST, 2), j, size(LimitStateValLIST, 2));
    ...
    fileNameToSave = 'DS2_DS3_criticalFloorDataCS22_SaTa_12NCEE';
%     cd 'H:\DamageState_MoRTSD\DayalaEtal2015_GEM\DS2_SigDam(Moderate)_DS3_NearColl(Extensive)'
