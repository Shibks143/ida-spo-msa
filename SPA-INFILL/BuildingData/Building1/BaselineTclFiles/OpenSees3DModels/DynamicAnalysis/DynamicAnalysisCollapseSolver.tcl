...
proc DynamicAnalysisCollapseSolver {dt dt_anal_Step GMtime numStories DriftLimit FloorNodes h1 htyp startTime groundMotionDirection} {
...
MaxDriftTester $numStories $DriftLimit $FloorNodes $h1 $htyp $groundMotionDirection
if  {$CollapseFlag == "YES"} {
	set ok 0
}
