...
function defineInfillStrutMaterialsForEigenValueAnalysis3DModel(...
    buildingGeometry,xInfillObjects,zInfillObjects,...
    BuildingModelDirectory,XInfillPropertiesLocation,...
    ZInfillPropertiesLocation,AnalysisType)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % Load text file with Z-DirectionNonSpine infill strut locations
    ...
    fid = fopen('DefineInfillStrutMaterialsForEigenValueAnalysis3DModel.tcl','wt');
    ...
    fprintf(fid,'%s\n','puts "non-spine infill materials defined"');
    fprintf(fid,'%s\n','');
