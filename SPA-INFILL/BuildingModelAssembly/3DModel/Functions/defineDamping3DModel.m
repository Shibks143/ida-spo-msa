...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fprintf(fid,'%s\t',xBeamObjects{1,1,1}.openSeesTag);
    fprintf(fid,'%s\t',zBeamObjects{buildingGeometry.numberOfStories,buildingGeometry.numberOfXBays + 1,buildingGeometry.numberOfZBays}.openSeesTag);
    ...
    fprintf(fid,'%s\t',columnObjects{1,1,1}.openSeesTag);
    fprintf(fid,'%s\t',columnObjects{buildingGeometry.numberOfStories,buildingGeometry.numberOfXBays + 1,buildingGeometry.numberOfZBays + 1}.openSeesTag);
    fprintf(fid,'%s\n','-rayleigh $alpha1 0 $alpha2ToUse 0;');
    ...
    fprintf(fid,'%s\t',jointNodes{buildingGeometry.numberOfStories + 1,buildingGeometry.numberOfXBays + 1,buildingGeometry.numberOfZBays + 1}.openSeesTag);
    fprintf(fid,'%s\n','-rayleigh $alpha1 0 $alpha2ToUse 0;');
