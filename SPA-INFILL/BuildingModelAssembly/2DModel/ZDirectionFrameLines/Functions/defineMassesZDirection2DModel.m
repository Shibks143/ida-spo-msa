...
function defineMassesZDirection2DModel(buildingGeometry,buildingLoads,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    TypicalBeamDepth = sqrt(zBeamObjects{1,1,1}.area);
    ...
    numberOfCornerNodesPerFloor = (buildingGeometry.numberOfZBays + 2);

    % Compute number of beam hinge nodes per floor
    numberOfBeamHingeNodesPerFloor = 2*(buildingGeometry.numberOfZBays);

    % Compute number of column hinge nodes per floor
    numberOfColumnHingeNodesPerFloor = 2*(buildingGeometry.numberOfZBays...
        + 2);
    ...
    for i = 1:buildingGeometry.numberOfStories
        ...
        for j = 1:buildingGeometry.numberOfZBays + 1
            fprintf(fid,'%s\t','mass');
            fprintf(fid,'%s\t',columnObjects{i,FrameLineNumber,j}. ...
        ...
        for j = 1:buildingGeometry.numberOfZBays + 1
            fprintf(fid,'%s\t','mass');
            fprintf(fid,'%s\t',...
                    columnObjects{i,FrameLineNumber,j}. ...
