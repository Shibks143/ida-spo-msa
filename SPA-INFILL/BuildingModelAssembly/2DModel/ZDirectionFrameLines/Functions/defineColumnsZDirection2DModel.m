...
function defineColumnsZDirection2DModel(buildingGeometry,columnObjects,...
    ...
    for i = 1:buildingGeometry.numberOfStories
        ...
        for j = 1:(buildingGeometry.numberOfZBays + 1)
            ...
            fprintf(fid,'%s\t',...
                ...
                fprintf(fid,'%10.3f\t',columnObjects{i,FrameLineNumber,...
                    j}.IgtrXX*...
                    columnObjects{i,FrameLineNumber,j}.EIeffOverEIg);
