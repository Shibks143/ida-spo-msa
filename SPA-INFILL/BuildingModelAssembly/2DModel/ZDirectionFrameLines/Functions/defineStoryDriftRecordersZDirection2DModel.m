...
function defineStoryDriftRecordersZDirection2DModel(buildingGeometry,...
    jointNodes,FrameLineNumber,BuildingModelDirectory,AnalysisType)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1:buildingGeometry.numberOfStories
        ...
        fprintf(fid,'%s\t',jointNodes{i,FrameLineNumber,1}.openSeesTag);
        fprintf(fid,'%s\t','-jNode');
        fprintf(fid,'%s\t',jointNodes{i + 1,FrameLineNumber,1}. ...
                openSeesTag);
        fprintf(fid,'%s\n','-dof 1 -perpDorn 2');
        fprintf(fid,'%s\n','');
    end
