...
% beam hinges
function defineColumnHingeRecordersZDirection2DModel(...
    buildingGeometry,columnHingeObjects,FrameLineNumber,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    elseif strcmp(AnalysisType,'DynamicAnalysis') == 1
        ...
        fprintf(fid,'%s\n',strcat('$baseDir/$dataDir/',...
            'MS_EQ_$MSeqNumber/MS_Scale_$MSScale/AS_EQ_$ASeqNumber/',...
            'AS_Scale_$ASScale/ColumnHingeMoment'));
        fprintf(fid,'%s\n','');
    end
    ...
    elseif strcmp(AnalysisType,'DynamicAnalysis') == 1
        ...
        fprintf(fid,'%s\n',strcat('$baseDir/$dataDir/',...
            'MS_EQ_$MSeqNumber/MS_Scale_$MSScale/AS_EQ_$ASeqNumber/',...
            'AS_Scale_$ASScale/ColumnHingeDeformations'));
        fprintf(fid,'%s\n','');
    end
