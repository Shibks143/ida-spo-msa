...
function defineGravityLoadsXDirection2DModel(buildingGeometry,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1:buildingGeometry.numberOfStories
        ...
        for j = 1:(buildingGeometry.numberOfXBays)
            ...
            fprintf(fid,'%10.3f',xBeamObjects{i,j,FrameLineNumber}. ...
                uniformXBeamLoads);
            fprintf(fid,'%s\n',';');
            fprintf(fid,'%s\n','');
        end
    ...
    for j = 1:(buildingGeometry.numberOfXBays + 1)
        ...
        for i = 1:buildingGeometry.numberOfStories
            ...
            fprintf(fid,'%s\t',jointNodes{i + 1,j,FrameLineNumber}. ...
                openSeesTag);
            fprintf(fid,'%u\t',0);
            fprintf(fid,'%10.3f\t',columnObjects{i,j,FrameLineNumber}. ...
    ...
    for i = 1:buildingGeometry.numberOfStories
        ...
        if buildingGeometry.numberOfStories > 8
            ...
            fprintf(fid,'%s\t',strcat(num2str(buildingGeometry. ...
                numberOfXBays + 2),num2str(i + 1)));
        end
        fprintf(fid,'%u\t',0);
        fprintf(fid,'%10.3f\t',buildingLoads. ...
            xFrameLineLeaningColumnLoads(i,FrameLineNumber));
        fprintf(fid,'%s\n',strcat(num2str(0),';'));        
    end
    fprintf(fid,'%s\n','');
    fprintf(fid,'%s\n','}');
