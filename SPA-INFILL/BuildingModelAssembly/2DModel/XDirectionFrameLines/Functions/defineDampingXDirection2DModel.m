...
function defineDampingXDirection2DModel(buildingGeometry,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fprintf(fid,'%s\t',xBeamObjects{1,1,FrameLineNumber}.openSeesTag);
    fprintf(fid,'%s\t',xBeamObjects{buildingGeometry.numberOfStories,...
        buildingGeometry.numberOfXBays,FrameLineNumber}.openSeesTag);
    ...
    fprintf(fid,'%s\t',columnObjects{1,1,FrameLineNumber}.openSeesTag);
    fprintf(fid,'%s\t',columnObjects{buildingGeometry.numberOfStories,...
        buildingGeometry.numberOfXBays + 1,FrameLineNumber}.openSeesTag);
    fprintf(fid,'%s\n','-rayleigh $alpha1 0 $alpha2ToUse 0;');
