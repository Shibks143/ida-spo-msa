...
function defineInfillStrutMaterials2DModel(buildingGeometry,...
    xDirectionInfillObjects,zDirectionInfillObjects,BuildingModelDirectory,...
    xDirectionInfillPropertiesLocation,ZInfillPropertiesLocation,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fid = fopen('DefineInfillStrutMaterials2DModel.tcl','wt');
