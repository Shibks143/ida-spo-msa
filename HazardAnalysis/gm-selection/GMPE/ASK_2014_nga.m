...
function [Sa, sigma, period1] = ASK_2014_nga(M, T, Rrup, Rjb, Rx, Ry0, Ztor, delta, lambda, fas, HW, W, Z10, Vs30, FVS30, region)
...
if length (T) == 1 && T == 1000; % Compute Sa and sigma with pre-defined period
    ...
    for ip=1:length(period)-2
        [Sa(ip),sigma(ip)]=ASK_2014_sub_1(M, ip, Rrup, Rjb, Rx, Ry0, Ztor, delta, frv, fnm, fas, HW, W, Z10, Vs30, FVS30, region);
    end
    ...
    for i=1:length(T)
        ...
        if ( isempty(find(abs(period-Ti) < 0.0001))) % The user defined period requires interpolation
            ...
            [Sa_low, sigma_low] = ASK_2014_sub_1(M, ip_low, Rrup, Rjb, Rx, Ry0, Ztor, delta, frv, fnm, fas, HW, W, Z10, Vs30, FVS30, region);
            [Sa_high, sigma_high] = ASK_2014_sub_1(M, ip_high, Rrup, Rjb, Rx, Ry0, Ztor, delta, frv, fnm, fas, HW, W, Z10, Vs30, FVS30, region);
            ...
            [Sa(i), sigma(i)] = ASK_2014_sub_1(M, ip_T, Rrup, Rjb, Rx, Ry0,Ztor, delta, frv, fnm, fas, HW, W, Z10, Vs30, FVS30, region);
        end
    end
end
