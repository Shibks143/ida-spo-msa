function [imValLIST, afe_Sa_T1_LIST] = findHazValRaghukanth20260818_v4(hazardInputs, T1Curr)
...
[imValLIST, afeLISTLIST, periodList] = extractHazForLoc_20260818_v1(hazardInputs);
