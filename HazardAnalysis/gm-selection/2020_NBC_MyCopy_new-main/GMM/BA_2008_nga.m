    % coded by Yoshifumi Yamamoto, 11/10/08
%               Stanford University
...
%   updated 2009/05/05
%
% Boore and Atkinson attenuation equation, 2008 Ground-Motion Prediction
% Equations for the Average Horizontal Component of PGA, PGV, and 5%-Damped
% PSA at Spectral Periods between 0.01s and 10.0s
% David M. Boore and Gail M. Atkinson
% Earthquake Spectra, Volume 24, No.1, pages 99-138, February 2008
% 
...
function [Sa, sigma, period1] = BA_2008_nga (M, T, Rjb, Fault_Type, Vs30)
...
if(iflg==0);
    ...
    for it=1:1:nT;
        ...
        if (isempty(find(abs((period - Teach)) < 0.0001)));
            ...
            [sa_low, sigma_low] = BA_2008_nga(M, T_low, Rjb, Fault_Type, Vs30);
            [sa_hi,  sigma_hi]  = BA_2008_nga(M, T_hi,  Rjb, Fault_Type, Vs30);
...
function [Sa, sigma] = BA_2008_nga_sub (M, ip, Rjb, U,S,N,R, Vs30)
