...
%          This version does not include constant displacement effect
%   updated 2010/05/20
%   updated 2009/05/05
%
...
% this version of the model that omits the constant displacement check
function [Sa tsigma period1] = AS_2008_nga_mod_woCD(M, Vs30, T, Rrup, Rjb, Rx, dip, Ztor, Z10, W, FRV, FNM, FAS, FHW, FVS30)
Td = 10^( -1.25 + 0.3*M );
