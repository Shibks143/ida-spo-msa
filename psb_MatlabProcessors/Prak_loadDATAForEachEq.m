% function [collapseSaLevel, saLevelForEachRun, tolerance, isSingularForEachRun, isNonConvForEachRun, isCollapsedForEachRun] = Prak_loadDATAForEachEq()
%                     tempDir = pwd;
%                     cd ..;
%                     cd Output;
...
function [collapseSaLevel, saLevelForEachRun, tolerance, isSingularForEachRun, isNonConvForEachRun, isCollapsedForEachRun] = Prak_loadDATAForEachEq(fileNameToLoad)
try 
    load(fileNameToLoad, 'collapseSaLevel', 'saLevelForEachRun', 'tolerance', 'isSingularForEachRun', 'isNonConvForEachRun', 'isCollapsedForEachRun')
catch 
