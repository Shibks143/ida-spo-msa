...
figure(figNum);
    ...
    % Save an output file with the Beta0, Beta1, p-value, and
    % sigmaError (added by CBH for wood light frame sensitivity runs;
    % 12-17-08).  This can later be used to compute the ACMR values.
        fileName = sprintf('DATA_%s_%s.mat', plotNamePrefix, groundMotionSetUsed);
        beta0 = intercept;
        beta1 = slope;
        save(fileName, 'beta0', 'beta1', 'pValue', 'sigmaErrorOfPrediction');
