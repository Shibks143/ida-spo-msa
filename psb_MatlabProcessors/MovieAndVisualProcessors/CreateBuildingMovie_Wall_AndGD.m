%
% Procedure: CreateBuildingMovie_Wall_AndGD.m
% -------------------
% This procedure creates a movie of the WALL building shaking (or during a
% PO).  This does include ground displacement but does not includes
% vertical motion (the frame processor like this has vertical motion).
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[] = CreateBuildingMovie_Wall_AndGD(analysisType, buildingInfo, bldgID, eqNum, saLevel, movieID, saDefType)
...
% each step and then create the movie
    ...
    for currentAnalysisStepNum = 1:(numStepsInAnalysis)
        ...
        if((mod(currentAnalysisStepNum, numAnalysisStepsPerSample)) == 0)
            ...
            floorDispTotalVECTOR
            DrawDistortedWall_andGD(buildingInfo, bldgID, floorDispTotalVECTOR, curvatureDemandVECTOR, shearSpringDispDemandVECTOR, analysisType, eqNum, saLevel, titleOption, maxOnDemandCapacityRatioToPlot, saDefType);
            hold on
