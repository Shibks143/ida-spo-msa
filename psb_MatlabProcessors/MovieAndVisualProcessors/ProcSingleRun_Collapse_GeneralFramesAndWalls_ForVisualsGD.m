...
%
% -------------------
function[void] = ProcSingleRun_Collapse_GeneralFramesAndWalls_ForVisualsGD(analysisType, modelName, saTOneForRun, eqNumber)

% Doesn't have modelName
...
% NOTICE: 
%   - This does not have the joint PHR, beam/column PHR, and joint shear
%   distortion that I added to the primary processing file on 7-24-06
%   (CBH).
...
save(fileName, 'floorAccelToSave', 'storyDriftRatioToSave', 'maxConvergedTime', 'eqTimeLength',...
    'eqNum', 'scaleFactorForRun', 'saValue', 'isCurrentAnalysisConv', 'maxTolUsed', 'maxDriftRatioForFullStr', 'PGA', 'absMaxDisplOfFloor',...
    'saCompScaled', 'saGeoMeanScaled', 'nodeNumsAtEachFloorLIST', 'elementArray', 'nodeArray', 'ground', 'storyDriftRatioToSave', 'numStories', 'storyDriftRatio')
