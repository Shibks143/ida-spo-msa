%
% Procedure: CreateAllSubPlotsOfFrameAtCol.m
% -------------------
% Same as the other similar driver; just the processor
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[void] = psb_CreateAllSubPlotsOfFrameAtCol_proc(analysisTypeLIST, modelNameLIST, bldgID, eqNumberLIST)
...
%             disp(buildingInfo{2225}.numBays)
            psb_DrawFrameWithMaxPHForEQ_withSaveOption(buildingInfo, bldgID, analysisType, eqNumber, saAtCollapse, driftPlotOption, isSaveFile, titleOption, maxOnDemandCapacityRatioToPlot, saDefType);
