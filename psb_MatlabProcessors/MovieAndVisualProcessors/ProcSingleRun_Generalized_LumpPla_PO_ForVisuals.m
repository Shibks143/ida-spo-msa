...
%
% -------------------
function[void] = ProcSingleRun_Generalized_LumpPla_PO_ForVisuals(analysisType, saTOneForRun, eqNumber)
...
% for the story PO diagrams
    cd MatlabInformation
        columnNumsAtEachStoryLISTOUT = load('columnNumsAtEachStoryLISTOUT.out');
    cd ..;
end
