%
% Procedure: DrawDistortedWall_AndGD.m
% -------------------
% This procedure plots the frame in it's displaced shape.  This includes
% ground displacement, but not vertical motion.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[] = DrawDistortedWall_AndGD(buildingInfo, bldgID, floorDispTotalVECTOR, curvatureDemandVECTOR, shearSpringDispDemandVECTOR, analysisType, eqNum, saLevel, titleOption, maxOnDemandCapacityRatioToPlot, saDefType)
...
% Initialize the plot
    ...
    maxDimNeededForBldg = 1.40*max(xDimNeededForBldg, (yDimNeededForBldg * yScale));
...
% Draw a line for the ground
    ...
    xLeft = (-0.50*buildingInfo{bldgID}.wallWidth  + floorDispTotalVECTOR(1));
    xRight = (xDimNeededForBldg + 0.50*buildingInfo{bldgID}.wallWidth + floorDispTotalVECTOR(1));
...
% shear boxes in this same loop.
    for currentStory = 1:numStories
        ...
        % x-locations
        lineLocation_bottom_x_left = 0.0 + floorDispTotalVECTOR(currentFloorNum_bottom);
        lineLocation_top_x_left = 0.0 + floorDispTotalVECTOR(currentFloorNum_top);
        lineLocation_bottom_x_right = 0.0 + floorDispTotalVECTOR(currentFloorNum_bottom) + buildingInfo{bldgID}.wallWidth;
        lineLocation_top_x_right = 0.0 + floorDispTotalVECTOR(currentFloorNum_top) + buildingInfo{bldgID}.wallWidth;
        % y-locations
        if(currentStory == 1)
