...
%   a dot for the current response point. Includes ground displacements,
%   and vertical displacements in the frame
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[] = CreateSubPlots_Frame_AndGD_Traces(buildingInfo, bldgID, analysisType, eqNum, saLevel, floorDispTotalVECTOR, plasticRotationARRAY, elementArray, storyDriftRatio_Neg, storyDriftRatio_Pos, currentAnalysisStepNum, jointResponseToPlot_1, jointResponseToPlot_2, saDefType, ground, roof, verticalFloorDispVECTOR)%       saDefType - type of SA definition we want to put on the titles
%               =1 for Sa,comp
%               =2 for Sa,geoMean
%               =3 for Sa,codeDef)
...
% Do some simple calcs.
    ...
    titleOption = 2;
    maxOnDemandCapacityRatioToPlot = 10.0

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plot the deformed building
    subplot(3,2,1)
    DrawDistortedFrame_AndGD(buildingInfo, bldgID, floorDispTotalVECTOR, plasticRotationARRAY, analysisType, eqNum, saLevel, isHingesHighlighted, jointResponseToPlot_1, jointResponseToPlot_2, highlightedHingeColor_1, highlightedHingeColor_2,titleOption, maxOnDemandCapacityRatioToPlot, saDefType, verticalFloorDispVECTOR);%       saDefType - type of SA definition we want to put on the titles
...
% Plot the ground trace
   subplot(3,2,5)
   isGroundorRoof = 1; %1 for ground, 2 for roof
   DrawTraceWithDot(ground, currentAnalysisStepNum,isGroundorRoof);
   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plot the roof trace
   subplot(3,2,6)
   isGroundorRoof = 2;
   DrawTraceWithDot(roof, currentAnalysisStepNum, isGroundorRoof);
