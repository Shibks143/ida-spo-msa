% Procedure: FindAndReturnCollapseSaForEQ.m
% -------------------
%
% This function simply goes into the output files, opens the appropriate
% porocessed file and then find the Sa level that is the first to cause
% collapse.
%
...
%
% -------------------
function[saAtCollapse, saLevelsForIDAPlotLIST] = FindAndReturnCollapseSaForEQ(analysisType, modelName, eqNumber)

disp('Finding and returning collapse points...')
