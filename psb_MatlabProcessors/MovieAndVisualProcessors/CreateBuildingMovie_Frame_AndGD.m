%
% Procedure: CreateBuildingMovie_Frame_AndGD.m
% -------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[] = CreateBuildingMovie_Frame_AndGD(analysisType, buildingInfo, bldgID, eqNum, saLevel, movieID, saDefType)
...
% Set up the movie file
    ...
    %movieName = sprintf('Movie_%s_EQ_%d_Sa_%.2f_%d.wmf', analysisType, eqNum, saLevel, movieID) - doesn't work;
...
% each step and then create the movie
    ...
    for currentAnalysisStepNum = 1:(numStepsInAnalysis)
        ...
        if((mod(currentAnalysisStepNum, numAnalysisStepsPerSample)) == 0)
            ...
            % Now call the function and plot the displaced shape of the frame
            DrawDistortedFrame_AndGD(buildingInfo, bldgID, floorDispTotalVECTOR, plasticRotationARRAY, analysisType, eqNum, saLevel, isHingesHighlighted, hingeHighlighted_1, hingeHighlighted_2, highlightedHingeColor_1, highlightedHingeColor_2, titleOption, maxOnDemandCapacityRatioToPlot, saDefType, verticalFloorDispVECTOR);
            hold on
