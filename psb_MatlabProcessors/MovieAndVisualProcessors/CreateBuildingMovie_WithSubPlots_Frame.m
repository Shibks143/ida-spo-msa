%
% Procedure: CreateBuildingMovie_WithSubPlots_Frame.m
% -------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[] = CreateBuildingMovie_WithSubPlots_Frame(analysisType, buildingInfo, bldgID, eqNum, saLevel, movieIndex, jointResponseToPlot_1, jointResponseToPlot_2, saDefType)
...
% each step and then create the movie
    ...
    for currentAnalysisStepNum = 1:(numStepsInAnalysis)
        ...
        if((mod(currentAnalysisStepNum, numAnalysisStepsPerSample)) == 0)
            ...
            CreateSubPlotsWithBuildingAndResponses_singleAnalysisStep_Frame(buildingInfo, bldgID, analysisType, eqNum, saLevel, floorDispVECTOR, plasticRotationARRAY, elementArray, storyDriftRatio_Neg, storyDriftRatio_Pos, currentAnalysisStepNum, jointResponseToPlot_1, jointResponseToPlot_2, saDefType)
            hold on
