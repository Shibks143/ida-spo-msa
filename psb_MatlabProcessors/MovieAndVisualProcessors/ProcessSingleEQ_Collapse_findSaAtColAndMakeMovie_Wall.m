...
%
% -------------------
function[] = ProcessSingleEQ_Collapse_findSaAtCollapseAndMakeMovie_Wall(bldgID, analysisType, modelName, eqNumber, movieID)
...
% Now call the function to process the data and make the movie
    ProcessSingleEQ_Collapse_makeMovieForSingleSa_Wall(bldgID, analysisType, modelName, eqNumber, saAtCollapse, movieID, isEQOrPO);
