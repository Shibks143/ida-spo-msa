...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[] = CreateBuildingMovie_WithSubPlots_Frame_AndGD(analysisType, buildingInfo, bldgID, eqNum, saLevel, movieIndex, jointResponseToPlot_1, jointResponseToPlot_2, saDefType)
...
% each step and then create the movie
    ...
    for currentAnalysisStepNum = 1:(numStepsInAnalysis)
        ...
        if((mod(currentAnalysisStepNum, numAnalysisStepsPerSample)) == 0)
            ...
            CreateSubPlotsWithBuildingAndResponses_Frame_AndGD(buildingInfo, bldgID, analysisType, eqNum, saLevel, floorDispTotalVECTOR, plasticRotationARRAY, elementArray, storyDriftRatio_Neg, storyDriftRatio_Pos, currentAnalysisStepNum, jointResponseToPlot_1, jointResponseToPlot_2, saDefType)
            hold on
