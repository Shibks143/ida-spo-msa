...
%
% -------------------
function[void] = Delete_2ndCompOnly_PlotCollapseIDAs(analysisTypeLIST, eqNumberLIST, eqListForCollapseIDAs_Name, markerTypeLine, markerTypeDot, isPlotIndividualPoints, collapseDriftThreshold, isConvertToSaKircher)
...
for analysisTypeIndex = 1:length(analysisTypeLIST)
    ...
    Delete_2ndCompOnly_PlotCollapseIDAs_singleAnaType(analysisType, eqNumberLIST, eqListForCollapseIDAs_Name, markerTypeLine, markerTypeDot, isPlotIndividualPoints, collapseDriftThreshold, isConvertToSaKircher);
