...
%
% -------------------
function[void]= sks_PlotCollapseMSAs(analysisTypeLIST, eqNumberLIST_forCollapseMSAs, eqListForCollapseMSAs_Name, markerTypeLine, markerTypeDot, isPlotIndividualPoints, eqNumberLIST_forStripes, saLevelsForStripes,collapseDriftThreshold, isConvertToSaKircher);
