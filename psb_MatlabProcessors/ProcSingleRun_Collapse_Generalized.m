...
%
% -------------------
function[scaleFactorForRun, maxDriftRatioForFullStr, isNonConv, isSingular, isCollapsed] = ProcSingleRun_Collapse_Generalized(analysisType, modelName, saTOneForRun, eqNumber)
