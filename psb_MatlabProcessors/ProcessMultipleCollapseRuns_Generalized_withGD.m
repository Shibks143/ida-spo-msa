...
%
% -------------------
function[void] = ProcessMultipleCollapseRuns_Generalized_withGD(analysisTypeLIST, modelNameLIST, eqNumberLIST, collapseDriftThreshold, dataSavingOption)
                        ...
                        % RunCollapseAnaMATLAB_NEWER_proc will take care of this by perturbing the Sa value for convergence.
                            if((isCollapsedForEachRun(saLevelNum) == 0) && ((isSingularForEachRun(saLevelNum) == 1) || (isNonConvForEachRun(saLevelNum) == 1)))
                                ...
                                % Call the processing file to do the processing and to find the maxDriftLevel for each Sa level that was run...
                                    ...
                                    [scaleFactorForRun, maxDriftRatioForFullStr, isNonConv, isSingular, isCollapsed] = ProcSingleRun_Collapse_GeneralizedForFramesAndWalls_withGD(analysisType, modelName, saTOneForRun, eqNumber, dataSavingOption);
