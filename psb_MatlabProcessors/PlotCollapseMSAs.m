...
%
% -------------------
function[void]= PlotCollapseMSAs(analysisTypeLIST, eqNumberLIST, eqListForCollapseIDAs_Name, markerTypeLine, markerTypeDot, isPlotIndividualPoints, collapseDriftThreshold, isConvertToSaKircher)
