...
% MAFCollapse_SubFile_2.m
    ...
    % TESTING - this should be using a 1 second period!!!
    [MAFofCollapse_allComp_RTRAndModelVar] = ComputeMAFofCollapse(mean, sigma, distTypeForCDF, minSa, maxSa, numIntSteps, empiricalCDF);
...
% MAFCollapse_SubFile_2.m
    ...
    % TESTING - this should be using a 1 second period!!!
    [MAFofCollapse_controlComp_RTRAndModelVar] = ComputeMAFofCollapse(mean, sigma, distTypeForCDF, minSa, maxSa, numIntSteps, empiricalCDF);
