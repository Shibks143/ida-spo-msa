%
% Procedure: ComputeMAFofCollapse.m
% -------------------
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [MAFofCollapse, MAFofColDissag] = ComputeMAFofCollapse(mean, sigma, distTypeForCDF, minSa, maxSa, numIntSteps, empiricalCDF)
    ...
    % Follow HO # 9 - pg. 32 to do numerical integration
        ...
        for currentSa = (minSa + saIncr):saIncr:maxSa
            ...
            % this step)
                ...
                [hazardValue_atSaStar, hazardSlope_atSaStar] = HazardCurve_ReturnValueAndSlope(saStar);
