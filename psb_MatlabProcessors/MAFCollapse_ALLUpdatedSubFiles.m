...
% Simply a script file used when computing probabilities of collapse
    ...
    % Call function to compute MAF of collapse for LOGNORMAL collapse CDF
    % (only RTR variability)
    mean = meanLnCollapseSaTOneAllComp_adjForEpsilon;
    sigma = stDevLnCollapseSaTOneAllComp;
    distTypeForCDF = 'lnrm';
    empiricalCDF = 0.0; % Just junk because it is not use unless the empirical CDF option is being used
    period = modelFundamentalPeriod;
    [MAFofCollapse_allComp_withEpsilonAdj_OnlyRTRVar, MAFofColDissag] = ComputeMAFofCollapse_newerGeneralForSiteAndPeriod(mean, sigma, distTypeForCDF, minSa, maxSa, numIntSteps, empiricalCDF, siteNum, period);
    disp('Only including RTR variability and using LOGNORMAL collapse CDF, all comp., MAF is:')
    mean
    sigma
    MAFofCollapse_allComp_withEpsilonAdj_OnlyRTRVar
    %probOfColAtTwoInFifty = logncdf(twoPercentInFiftyYearSa, mean, sigma);
    %probOfColAtTwoInFifty
...
% MAFCollapse_SubFile_1.m
    ...
    % Call function to compute MAF of collapse for LOGNORMAL collapse CDF
    % (only RTR variability)
    mean = meanLnCollapseSaTOneControlComp_adjForEpsilon;
    sigma = stDevLnCollapseSaTOneControlComp;
    distTypeForCDF = 'lnrm';
    empiricalCDF = 0.0; % Just junk because it is not use unless the empirical CDF option is being used
    period = modelFundamentalPeriod;
    [MAFofCollapse_controlComp_withEpsilonAdj_OnlyRTRVar, MAFofColDissag] = ComputeMAFofCollapse_newerGeneralForSiteAndPeriod(mean, sigma, distTypeForCDF, minSa, maxSa, numIntSteps, empiricalCDF, siteNum, period);
    disp('Only including RTR variability and using LOGNORMAL collapse CDF, control comp., MAF is:')
    mean 
    sigma
    MAFofCollapse_controlComp_withEpsilonAdj_OnlyRTRVar
    %probOfColAtTwoInFifty = logncdf(twoPercentInFiftyYearSa, mean, sigma);
    %probOfColAtTwoInFifty
...
% Simply a script file used when computing probabilities of collapse
    ...
    empiricalCDF = 0.0; % Just junk because it is not use unless the empirical CDF option is being used
    period = modelFundamentalPeriod;
    [MAFofCollapse_allComp_withEpsilonAdj_RTRAndModelVar, MAFofColDissag] = ComputeMAFofCollapse_newerGeneralForSiteAndPeriod(mean, sigma, distTypeForCDF, minSa, maxSa, numIntSteps, empiricalCDF, siteNum, period);
    disp('Only including RTR AND FOSM variability and using LOGNORMAL collapse CDF, control comp., MAF is:')
    period
    mean
    sigma
    MAFofCollapse_allComp_withEpsilonAdj_RTRAndModelVar
    %probOfColAtTwoInFifty = logncdf(twoPercentInFiftyYearSa, mean, sigma);
    %probOfColAtTwoInFifty
...
% Simply a script file used when computing probabilities of collapse
    ...
    empiricalCDF = 0.0; % Just junk because it is not use unless the empirical CDF option is being used
    period = modelFundamentalPeriod;
    [MAFofCollapse_controlComp_withEpsilonAdj_RTRAndModelVar, MAFofColDissag] = ComputeMAFofCollapse_newerGeneralForSiteAndPeriod(mean, sigma, distTypeForCDF, minSa, maxSa, numIntSteps, empiricalCDF, siteNum, period);
    disp('Only including RTR AND FOSM variability and using LOGNORMAL collapse CDF, all comp., MAF is:')
    period
    mean
    sigma
    MAFofCollapse_controlComp_withEpsilonAdj_RTRAndModelVar
    %probOfColAtTwoInFifty = logncdf(twoPercentInFiftyYearSa, mean, sigma);
    %probOfColAtTwoInFifty
