...
% saTOneForStripeLIST = [0.10, 0.19, 0.26, 0.44, 0.55, 0.82];   % No stripe 7
% saTOneForStripeLIST = [0.10, 0.19, 0.26, 0.33, 0.44, 0.55, 0.82];   % With stripe 7 of 0.33
saTOneForStripeLIST = [0.82];   % With stripe 7 of 0.30
...
modelVersionPrefix = '(DesID1_v.60)_';       % LATER, MAKE THIS AN INPUT PARAMETER
% modelVersionPrefix = '(DesID3_v.5)_';       % LATER, MAKE THIS AN INPUT PARAMETER
% modelVersionPrefix = '(DesID4_v.1)_';       % LATER, MAKE THIS AN INPUT PARAMETER
               ...
               % Plot stats
                if (plotMeanLine == 1)
                    ...
                    % Now plot the IDA lines for +/- 1.0 sigmaRTR
                        ...
                        markerType = 'b';
                        plot(meanMinusSigmaRTRResponceForPlotX, saLevelForPlotY, varIDAMarkerType);
                        ...
                        markerType = 'b';
                        plot(meanPlusSigmaRTRResponceForPlotX, saLevelForPlotY, varIDAMarkerType);    
                    ...
                    % Now plot the mean IDA, the mean +/- one sigmaRTR IDA, and the mean +/- one sigmaTOTAL IDA
                        % Plot the mean IDA line (the mean responce of the AllVar=Mean run)
                            ...
                            for stripeIndex = 1:length(saTOneForStripeLIST)
                                    ...
                                    meanResponceForPlot(1, stripeIndex + 1) = maxFloorAccelAllStripes{stripeIndex}{floorNum}.MeanConvEQsUnfiltered / g; % Changed to unfiltered on 10-6-04! 
                ...
                if (plotMeanLine == 1)
                    ...
                    % Now plot the mean IDA, the mean +/- one sigmaRTR IDA, and the mean +/- one sigmaTOTAL IDA
                        % Plot the mean IDA line (the mean responce of the AllVar=Mean run)
                            ...
                            % Loop for all stripe and populate the vector
                            for stripeIndex = 1:length(saTOneForStripeLIST)
                                meanResponceForPlot(1, stripeIndex + 1) = maxColPHRInFullFrameAllStripes{stripeIndex}.maxHingeRot.MeanConvEQs; 
                            end                                                                                               
                ...
                if (plotMeanLine == 1)
                    ...
                    % Now plot the mean IDA, the mean +/- one sigmaRTR IDA, and the mean +/- one sigmaTOTAL IDA
                        % Plot the mean IDA line (the mean responce of the AllVar=Mean run)
                            ...
                            % Loop for all stripe and populate the vector
                            for stripeIndex = 1:length(saTOneForStripeLIST)
                                meanResponceForPlot(1, stripeIndex + 1) = maxBmPHRInFullFrameAllStripes{stripeIndex}.maxHingeRot.MeanConvEQs; 
                            end                                                                                               
